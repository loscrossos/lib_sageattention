...
print("start!")
test_selective_scan(is_variable_B, is_variable_C, varBC_groups, has_D, has_z, has_delta_bias, delta_softplus, return_last_state, seqlen, itype, wtype)
print("PASSED1!")
#test_mamba_inner_fn(is_variable_B, is_variable_C, seqlen, itype, wtype)
